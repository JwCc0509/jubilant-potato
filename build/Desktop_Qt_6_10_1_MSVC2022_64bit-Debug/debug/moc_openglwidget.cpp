...
void OpenGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->imageLoaded((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (OpenGLWidget::*)(bool )>(_a, &OpenGLWidget::imageLoaded, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (OpenGLWidget::*)(float )>(_a, &OpenGLWidget::zoomChanged, 1))
            return;
    }
}
...
// SIGNAL 0
void OpenGLWidget::imageLoaded(bool _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void OpenGLWidget::zoomChanged(float _t1)
{
