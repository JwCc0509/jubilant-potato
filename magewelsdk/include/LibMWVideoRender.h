...
typedef enum _colorformat {
	...
	MW_RENDER_RGB24 = 51,
	MW_RENDER_MONO8 = 101,
	MW_RENDER_MONO10 = 102,
	MW_RENDER_MONO12 = 103,
	MW_RENDER_MONO14 = 104,
	MW_RENDER_MONO16 = 105,

	MW_RENDER_BAYERBG8 = 201,
	MW_RENDER_BAYERBG10 = 202,
	MW_RENDER_BAYERBG12 = 203,
	MW_RENDER_BAYERBG14 = 204,
	MW_RENDER_BAYERBG16 = 205,

	MW_RENDER_BAYERGB8 = 301,
	MW_RENDER_BAYERGB10 = 302,
	MW_RENDER_BAYERGB12 = 303,
	MW_RENDER_BAYERGB14 = 304,
	MW_RENDER_BAYERGB16 = 305,

	MW_RENDER_BAYERGR8 = 401,
	MW_RENDER_BAYERGR10 = 402,
	MW_RENDER_BAYERGR12 = 403,
	MW_RENDER_BAYERGR14 = 404,
	MW_RENDER_BAYERGR16 = 405,

	MW_RENDER_BAYERRG8 = 501,
	MW_RENDER_BAYERRG10 = 502,
	MW_RENDER_BAYERRG12 = 503,
	MW_RENDER_BAYERRG14 = 504,
	MW_RENDER_BAYERRG16 = 505,
	MW_RENDER_COUNT,
}mw_colorformat_e;
...
extern "C"
{
	...
	mw_videorender_result_e 
	LIBMWVIDEORENDER_API MWOSDSetPos(HMWVIDEORENDER t_hvideorender, float center_x, float center_y, float width, float height);

	mw_videorender_result_e
		LIBMWVIDEORENDER_API MWOSDSetShow(HMWVIDEORENDER t_hvideorender, BOOL bShow);

	BOOL LIBMWVIDEORENDER_API MWOSDIsShow(HMWVIDEORENDER t_hvideorender);
